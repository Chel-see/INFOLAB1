...
print("--------------------SETS------------------------")
print(
    "Note Lists, Sets and Tuples are iterables and therefore support the for x in collection syntax."
)
data = [20, 3, 20, 42, 2, 3, 10, 32, 2]

myset = {0, 1}

for num in data:  #for all the numebrs that ae in the set "data" and that are not present in myset after being added or  before
  myset.add(num)

print(myset)  # {0, 1, 2, 3, 32, 42, 10, 20}
num_unique = len(myset)
print("======================dictionaries====================")
mydict = {"name": "bob", "age": 34}
